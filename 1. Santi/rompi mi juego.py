...
while (numerodeveces <= 10) and (ganaste < 1):
    ...
    if numeroelegido != numerorandom:
        ...
        listadenumeros.append(numeroelegido)

    if numeroelegido == numerorandom:
        ganaste = ganaste + 1
        print("GANASTE", "el numero era él: ", numerorandom,
              "adivinaste en: ", ganasteen, "chances")
        print("estos son tus numeros elegidos: ", listadenumeros)
